...
cat <<EOF_JSON
{
  "hookSpecificOutput": {
    ...
    "permissionDecisionReason": "Large new code file creation is blocked for Write. Use mcp__delegate__codex with sandbox: workspace-write and approval-policy: on-failure. Always set cwd to absolute path: $ABS_CWD. Follow CLAUDE.md Codex Delegation rules."
  }
}
EOF_JSON
